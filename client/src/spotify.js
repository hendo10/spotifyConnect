...
/**
 * Checks if the amount of time that has elapsed between timestampe in localStorage
...
const refreshToken = async () => {
    try {
        // Logout if there is no refresh token stored or we've managed to get into a reload infinite loop
